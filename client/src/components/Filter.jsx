...
export default function Filter() {
  ...
  const status = ["active", "in-progress", "completed", "cancelled"];
  const time = ["10:00 AM", "12:00 PM", "2:00 PM"];
      ...
      >
        ...
        >
          <div className="flex flex-col">
            <h1 className="text-lg font-bold mb-4 text-white">Apply filters</h1>
